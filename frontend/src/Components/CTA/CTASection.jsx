  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-14">
        ...
        <p className="mt-4 text-white/65 text-md max-w-sm mx-auto leading-relaxed">
          Fill out this inquiry form to connect with the library admin regarding admission.
        </p>
      </div>
