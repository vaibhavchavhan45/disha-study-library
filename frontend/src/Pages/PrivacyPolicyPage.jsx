    ...
    <div style={{ background: "radial-gradient(ellipse at top, #0f2d3d 0%, #09101f 40%, #060812 70%)" }} className="min-h-screen w-full">
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-6 md:px-8 pt-22 md:pt-28 lg:pt-32 pb-20">
        ...
        <div className="mb-10">
          ...
          <h2 className="text-white text-xl font-bold mb-3">Your Privacy Matters</h2>
          <p className="text-white/60 text-sm leading-relaxed">
            At Crystal, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you interact with our services.
          </p>
        </div>
